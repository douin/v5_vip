...
public class GUI extends JFrame{
    ...
    public GUI(){
        super("éditeur du fichier de configuration");
        ...
        configText.setText("#  voir le fichier " + FILE_NAME + ", même répertoire\n" + example);
        //
        ...
        WindowAdapter windowAdapter = new WindowAdapter() {
                ...
                public void windowClosing(WindowEvent e) {
                    ...
                    if(outFile!=null){
                        outFile.flush();
                        outFile.close();
                        String message = "Après analyse, le fichier généré semble correct pour femtoContainer...";
                        try{
                            verifyProperties();
        ...
        public void actionPerformed(ActionEvent ae){
            ...
            if(number==1 && first){
                ...
                try{
                    ...
                    configText.setText("# fichier créé: .\\" + FILE_NAME);
