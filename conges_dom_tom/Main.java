...
import conges_v1.ResultatConges;
...
public class Main{
    ...
    public static void main(String[] args){
        ApplicationContext ctx = Factory.createApplicationContext("./conges_dom_tom/README.TXT");
        ...
        List<AgentF> liste = new ArrayList<>();
        liste.add( agent);
        
        ResultatConges resultat = new ResultatConges();
        try{
            Invocateur<AgentF,ResultatConges> invocateur = ctx.getBean("dom_tom.estimation_conges_restants");
            
            for( AgentF a : liste)
              invocateur.invoquer(a, resultat);
