...
public class Main{
    ...
    public static void main(String[] args){
        ApplicationContext ctx = Factory.createApplicationContext("./conges_metropole/README.TXT");
       ...
       AgentF agent = new AgentF(){
        ...
        try{
            Invocateur<AgentI,ResultatConges> invocateur = ctx.getBean("metropole.estimation_conges_restants");
